...
//Corrected error which occured in file 'LL_reverse_error.c' in Line 151.
...
int main(int argc, char **argv) {
    ...
    // As the pointers have been reversed in function reverse, we have to re-reverse it function Chunreverse to execute properly.
